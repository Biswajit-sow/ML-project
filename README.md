...
IF you want to deploy this then write"app.launch(share=True)"..in the code and it is valid for 7 days-(https://29a186de653736b3f8.gradio.live) .If you want to permanant valid deploy use **gradio deploy** code in terminal and then hugging face.
